...
<?php
	$sel_query = "SELECT  `title`, `path` FROM `downloads`";
	if ($sel_res = mysqli_query($dbcon,$sel_query)) {
			
		if (mysqli_num_rows($sel_res) == 0) {
			echo "<h3>Currently No Download Formats are available....</h3>";
		}
		else
		{
?>
				<table width="60%" cellpadding="8px" cellspacing="10px" align="center">
					<tr>
						<th>Title</th>
...
<?php				
	...
	{
		echo "Contact Admin !! Some tech issues are there :( ";
	}
?>
	</div>
	<div id="footer">
